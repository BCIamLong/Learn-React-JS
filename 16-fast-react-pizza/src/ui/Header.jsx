...
function Header() {
  return (
    <header className="border-y-4 border-dashed border-yellow-600 bg-yellow-500  uppercase">
      ...
      <div className="p-3 py-4 text-center text-2xl font-bold tracking-[0.3rem] sm:py-6 sm:text-4xl">
