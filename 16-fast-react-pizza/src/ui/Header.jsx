...
function Header() {
  return (
    <header className="flex items-center justify-between gap-3 self-start border-y-4 border-dashed border-yellow-600 bg-yellow-500  px-3 uppercase text-productColor sm:px-6">
      ...
      <div className="text-1xl py-4 text-center font-bold tracking-[0.3rem] sm:py-6 sm:text-4xl">
